...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-1232](bugs/BUG-1232-reader-floating-chrome-shortcut.md) | ✅ | ✅ | 阅读器悬浮控制栏快捷键未驱动临时显隐状态 |
| [BUG-1231](bugs/BUG-1231-shortcut-capture-ime-physical.md) | ✅ | ✅ | 快捷键录入在 IME 下无法识别物理 Z |
