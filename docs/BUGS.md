...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-1357](bugs/BUG-1357-media-sources-sync-refresh.md) | ✅ | ✅ | 同步导入 Mokuro 配置后已打开 Sources 行仍显示旧状态 |
| [BUG-1356](bugs/BUG-1356-interconnect-service-config-http.md) | ✅ | ✅ | 互联 service-config 在 HTTP 上泄露 peer token 并接受伪 host 配置 |
