...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-782](bugs/BUG-782-lyrics-mode-persist-reentry.md) | ✅ | ✅ | 重新进入书籍不再是歌词模式（歌词模式跨会话不恢复） |
| [BUG-781](bugs/BUG-781-lyrics-follow-scroll-window-noop.md) | ✅ | ✅ | 歌词模式音频跟随「高亮变但不滚动」（window.scrollBy 空转） |
