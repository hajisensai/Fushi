...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-873](bugs/BUG-873-galgame-mining-window-picture.md) | ✅ | ✅ | Galgame 制卡缺少绑定游戏窗口截图 Picture |
| [BUG-872](bugs/BUG-872-galgame-sentence-audio-ankiconnect-timeout.md) | ✅ | ✅ | Galgame SentenceAudio upload times out and creates an incomplete Anki card |
| [BUG-871](bugs/BUG-871-galgame-mining-occurrence-sentence.md) | ✅ | ✅ | 主查词页制卡丢失 Galgame 音频 occurrence 与整句 |
| [BUG-870](bugs/BUG-870-clipboard-notification-read-race.md) | ✅ | ✅ | Luna 剪贴板变化被通知/读取竞态漏掉 |
