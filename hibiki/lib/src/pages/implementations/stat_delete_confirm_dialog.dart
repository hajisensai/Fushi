...
/// 弹窗本体收敛到与书架删除确认共享的 [DeleteScopeConfirmDialog]（无勾选行形态，
/// pop bool）。
@visibleForTesting
...
/// 同壳（共享 [DeleteScopeConfirmDialog] 本体 + 破坏性动作），但清空范围是**整个域**
/// （全部书 / 全部视频）的纯统计数字，故独立标题、破坏性确认按钮，正文 [message]
/// 由调用页按阅读 / 视频域各自传入（明确列出清什么、保留什么、不可逆）。
@visibleForTesting
