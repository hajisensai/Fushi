...
public abstract class ColorSpace {
    ...
    static {
        sNamedColorSpaceMap.put(Named.SRGB.ordinal(), new Rgb(
                "sRGB IEC61966-2.1",
                SRGB_PRIMARIES,
                ILLUMINANT_D65,
                null,
        ...
        sNamedColorSpaceMap.put(Named.LINEAR_SRGB.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.EXTENDED_SRGB.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.LINEAR_EXTENDED_SRGB.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.BT709.ordinal(), new Rgb(
                "Rec. ITU-R BT.709-5",
                SRGB_PRIMARIES,
                ILLUMINANT_D65,
                null,
        ...
        sNamedColorSpaceMap.put(Named.BT2020.ordinal(), new Rgb(
                "Rec. ITU-R BT.2020-1",
                BT2020_PRIMARIES,
                ILLUMINANT_D65,
                null,
        ...
        sNamedColorSpaceMap.put(Named.DCI_P3.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.DISPLAY_P3.ordinal(), new Rgb(
                "Display P3",
                DCI_P3_PRIMARIES,
                ILLUMINANT_D65,
                null,
        ...
        sNamedColorSpaceMap.put(Named.NTSC_1953.ordinal(), new Rgb(
                "NTSC (1953)",
                NTSC_1953_PRIMARIES,
                ILLUMINANT_C,
                null,
        ...
        sNamedColorSpaceMap.put(Named.SMPTE_C.ordinal(), new Rgb(
                "SMPTE-C RGB",
        ...
        sNamedColorSpaceMap.put(Named.ADOBE_RGB.ordinal(), new Rgb(
                "Adobe RGB (1998)",
        ...
        sNamedColorSpaceMap.put(Named.PRO_PHOTO_RGB.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.ACES.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.ACESCG.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.CIE_LAB.ordinal(), new Lab(
                "Generic L*a*b*",
                Named.CIE_LAB.ordinal()
        ));
        sNamedColorSpaceMap.put(Named.BT2020_HLG.ordinal(), new Rgb(
        ...
        sNamedColorSpaceMap.put(Named.BT2020_PQ.ordinal(), new Rgb(
